...
userSchema.methods.comparePassword = async function(candidatePassword){
    return await bcrypt.compare(candidatePassword, this.password); // Compare the provided candidate password with the hashed password stored in the database. This method will return true if the passwords match and false if they don’t.
}
